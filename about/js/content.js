...
angular.module("aboutModule").constant("articles", {
	...
	"techTalk": {
		...
		image: "",
		body: "Today I presented a cross section of recent developments in web technologies to my collegues. It was inspired by the things I saw at Render 2017 and I feel it provided some valuable information to help people think outside of the standard web technoligies they have been using. I hope it has made some people think about some really cool things they can introduce to their current or future projects."
	}
});
